...
// CronsApiService CronsApi service
type CronsApiService service
 ...
 * @param inlineObject2
@return ScalewayFunctionsV1alpha2Cron
*/
func (a *CronsApiService) CreateCron(ctx _context.Context, region string, inlineObject2 InlineObject2) (ScalewayFunctionsV1alpha2Cron, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  ScalewayFunctionsV1alpha2Cron
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/functions/v1alpha2/regions/{region}/crons"
...
@return ScalewayFunctionsV1alpha2Cron
*/
func (a *CronsApiService) DeleteCron(ctx _context.Context, region string, cronId string) (ScalewayFunctionsV1alpha2Cron, *_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/functions/v1alpha2/regions/{region}/crons/{cron_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"region"+"}", _neturl.QueryEscape(parameterToString(region, "")) , -1)

	localVarPath = strings.Replace(localVarPath, "{"+"cron_id"+"}", _neturl.QueryEscape(parameterToString(cronId, "")) , -1)
...
@return ScalewayFunctionsV1alpha2Cron
*/
func (a *CronsApiService) GetCron(ctx _context.Context, region string, cronId string) (ScalewayFunctionsV1alpha2Cron, *_nethttp.Response, error) {
	var (
...
// ListCronsOpts Optional parameters for the method 'ListCrons'
type ListCronsOpts struct {
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param region The region you want to target
 * @param optional nil or *ListCronsOpts - Optional Parameters:
 * @param "Page" (optional.Float32) -  Page number
 * @param "PageSize" (optional.Float32) -  Page size
 * @param "OrderBy" (optional.Interface of ScalewayFunctionsV1alpha2ListCronsRequestOrderBy) - 
 * @param "ApplicationId" (optional.String) - 
@return ScalewayFunctionsV1alpha2ListCronsResponse
*/
func (a *CronsApiService) ListCrons(ctx _context.Context, region string, localVarOptionals *ListCronsOpts) (ScalewayFunctionsV1alpha2ListCronsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  ScalewayFunctionsV1alpha2ListCronsResponse
	)
...
@return ScalewayFunctionsV1alpha2Cron
*/
func (a *CronsApiService) UpdateCron(ctx _context.Context, region string, cronId string, inlineObject3 InlineObject3) (ScalewayFunctionsV1alpha2Cron, *_nethttp.Response, error) {
	var (
