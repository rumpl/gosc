...
/*
DeployContainer Method for DeployContainer
...
*/
func (a *DefaultApiService) DeployContainer(ctx _context.Context, region string, containerId string, body map[string]interface{}) (ScalewayFunctionsV1alpha2Container, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/functions/v1alpha2/regions/{region}/containers/{container_id}/deploy"
...
/*
DeployFunction Method for DeployFunction
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param region The region you want to target
 * @param functionId
 * @param body
@return ScalewayFunctionsV1alpha2Function
*/
func (a *DefaultApiService) DeployFunction(ctx _context.Context, region string, functionId string, body map[string]interface{}) (ScalewayFunctionsV1alpha2Function, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  ScalewayFunctionsV1alpha2Function
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/functions/v1alpha2/regions/{region}/functions/{function_id}/deploy"
	localVarPath = strings.Replace(localVarPath, "{"+"region"+"}", _neturl.QueryEscape(parameterToString(region, "")) , -1)

	localVarPath = strings.Replace(localVarPath, "{"+"function_id"+"}", _neturl.QueryEscape(parameterToString(functionId, "")) , -1)
...
/*
GetFunctionDownloadURL Method for GetFunctionDownloadURL
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param region The region you want to target
 * @param functionId
@return ScalewayFunctionsV1alpha2DownloadUrl
*/
func (a *DefaultApiService) GetFunctionDownloadURL(ctx _context.Context, region string, functionId string) (ScalewayFunctionsV1alpha2DownloadUrl, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  ScalewayFunctionsV1alpha2DownloadUrl
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/functions/v1alpha2/regions/{region}/functions/{function_id}/download-url"
	localVarPath = strings.Replace(localVarPath, "{"+"region"+"}", _neturl.QueryEscape(parameterToString(region, "")) , -1)
...
// GetFunctionUploadURLOpts Optional parameters for the method 'GetFunctionUploadURL'
type GetFunctionUploadURLOpts struct {
    ContentLength optional.Float32
}

/*
GetFunctionUploadURL Method for GetFunctionUploadURL
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param region The region you want to target
 * @param functionId
 * @param optional nil or *GetFunctionUploadURLOpts - Optional Parameters:
 * @param "ContentLength" (optional.Float32) - 
@return ScalewayFunctionsV1alpha2UploadUrl
*/
func (a *DefaultApiService) GetFunctionUploadURL(ctx _context.Context, region string, functionId string, localVarOptionals *GetFunctionUploadURLOpts) (ScalewayFunctionsV1alpha2UploadUrl, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  ScalewayFunctionsV1alpha2UploadUrl
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/functions/v1alpha2/regions/{region}/functions/{function_id}/upload-url"
	localVarPath = strings.Replace(localVarPath, "{"+"region"+"}", _neturl.QueryEscape(parameterToString(region, "")) , -1)
	...
	if localVarOptionals != nil && localVarOptionals.ContentLength.IsSet() {
		localVarQueryParams.Add("content_length", parameterToString(localVarOptionals.ContentLength.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
// IssueJWTOpts Optional parameters for the method 'IssueJWT'
type IssueJWTOpts struct {
...
/*
IssueJWT Method for IssueJWT
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param region The region you want to target
 * @param optional nil or *IssueJWTOpts - Optional Parameters:
 * @param "FunctionId" (optional.String) - 
 * @param "ContainerId" (optional.String) - 
 * @param "NamespaceId" (optional.String) - 
 * @param "ExpirationDate" (optional.Time) - 
@return ScalewayFunctionsV1alpha2Token
*/
func (a *DefaultApiService) IssueJWT(ctx _context.Context, region string, localVarOptionals *IssueJWTOpts) (ScalewayFunctionsV1alpha2Token, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  ScalewayFunctionsV1alpha2Token
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/functions/v1alpha2/regions/{region}/jwt/issue"
	localVarPath = strings.Replace(localVarPath, "{"+"region"+"}", _neturl.QueryEscape(parameterToString(region, "")) , -1)
	...
	if localVarOptionals != nil && localVarOptionals.FunctionId.IsSet() {
		localVarQueryParams.Add("function_id", parameterToString(localVarOptionals.FunctionId.Value(), ""))
	}
