...
*/
func (a *FunctionsApiService) CreateFunction(ctx _context.Context, region string, inlineObject4 InlineObject4) (ScalewayFunctionsV1alpha2Function, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/functions/v1alpha2/regions/{region}/functions"
...
@return ScalewayFunctionsV1alpha2Function
*/
func (a *FunctionsApiService) DeleteFunction(ctx _context.Context, region string, functionId string) (ScalewayFunctionsV1alpha2Function, *_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/functions/v1alpha2/regions/{region}/functions/{function_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"region"+"}", _neturl.QueryEscape(parameterToString(region, "")) , -1)
...
@return ScalewayFunctionsV1alpha2Function
*/
func (a *FunctionsApiService) GetFunction(ctx _context.Context, region string, functionId string) (ScalewayFunctionsV1alpha2Function, *_nethttp.Response, error) {
	var (
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param region The region you want to target
@return ScalewayFunctionsV1alpha2ListFunctionRuntimesResponse
*/
func (a *FunctionsApiService) ListFunctionRuntimes(ctx _context.Context, region string) (ScalewayFunctionsV1alpha2ListFunctionRuntimesResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  ScalewayFunctionsV1alpha2ListFunctionRuntimesResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/functions/v1alpha2/regions/{region}/runtimes"
	localVarPath = strings.Replace(localVarPath, "{"+"region"+"}", _neturl.QueryEscape(parameterToString(region, "")) , -1)
...
// ListFunctionsOpts Optional parameters for the method 'ListFunctions'
type ListFunctionsOpts struct {
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param region The region you want to target
 * @param optional nil or *ListFunctionsOpts - Optional Parameters:
 * @param "Page" (optional.Float32) -  Page number
 * @param "PageSize" (optional.Float32) -  Page size
 * @param "OrderBy" (optional.Interface of ScalewayFunctionsV1alpha2ListFunctionsRequestOrderBy) - 
 * @param "NamespaceId" (optional.String) - 
 * @param "Name" (optional.String) - 
 * @param "OrganizationId" (optional.String) - 
@return ScalewayFunctionsV1alpha2ListFunctionsResponse
*/
func (a *FunctionsApiService) ListFunctions(ctx _context.Context, region string, localVarOptionals *ListFunctionsOpts) (ScalewayFunctionsV1alpha2ListFunctionsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  ScalewayFunctionsV1alpha2ListFunctionsResponse
	)
...
@return ScalewayFunctionsV1alpha2Function
*/
func (a *FunctionsApiService) UpdateFunction(ctx _context.Context, region string, functionId string, inlineObject5 InlineObject5) (ScalewayFunctionsV1alpha2Function, *_nethttp.Response, error) {
	var (
