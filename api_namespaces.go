 ...
 * @param inlineObject6
@return ScalewayFunctionsV1alpha2Namespace
*/
func (a *NamespacesApiService) CreateNamespace(ctx _context.Context, region string, inlineObject6 InlineObject6) (ScalewayFunctionsV1alpha2Namespace, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  ScalewayFunctionsV1alpha2Namespace
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/functions/v1alpha2/regions/{region}/namespaces"
...
@return ScalewayFunctionsV1alpha2Namespace
*/
func (a *NamespacesApiService) DeleteNamespace(ctx _context.Context, region string, namespaceId string) (ScalewayFunctionsV1alpha2Namespace, *_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/functions/v1alpha2/regions/{region}/namespaces/{namespace_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"region"+"}", _neturl.QueryEscape(parameterToString(region, "")) , -1)
...
@return ScalewayFunctionsV1alpha2Namespace
*/
func (a *NamespacesApiService) GetNamespace(ctx _context.Context, region string, namespaceId string) (ScalewayFunctionsV1alpha2Namespace, *_nethttp.Response, error) {
	var (
...
// ListNamespacesOpts Optional parameters for the method 'ListNamespaces'
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param region The region you want to target
 * @param optional nil or *ListNamespacesOpts - Optional Parameters:
 * @param "Page" (optional.Float32) -  Page number
 * @param "PageSize" (optional.Float32) -  Page size
 * @param "OrderBy" (optional.Interface of ScalewayFunctionsV1alpha2ListNamespacesRequestOrderBy) - 
 * @param "Name" (optional.String) - 
 * @param "OrganizationId" (optional.String) - 
@return ScalewayFunctionsV1alpha2ListNamespacesResponse
*/
func (a *NamespacesApiService) ListNamespaces(ctx _context.Context, region string, localVarOptionals *ListNamespacesOpts) (ScalewayFunctionsV1alpha2ListNamespacesResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  ScalewayFunctionsV1alpha2ListNamespacesResponse
	)
...
@return ScalewayFunctionsV1alpha2Namespace
*/
func (a *NamespacesApiService) UpdateNamespace(ctx _context.Context, region string, namespaceId string, inlineObject7 InlineObject7) (ScalewayFunctionsV1alpha2Namespace, *_nethttp.Response, error) {
	var (
